...
(new-object net.webclient).DownloadFile("https://raw.githubusercontent.com/vibhcool/emerge/EmergeBootstrap_test/setup/EmergeBootstrap.py", "$Script:installRoot\download\EmergeBootstrap.py")
