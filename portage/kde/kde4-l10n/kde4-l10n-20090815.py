...
class subinfo( info.infoclass ):
    def setTargets( self ):
        for ver in ['0', '1', '2', '3', '4']:
          self.targets['4.8.' + ver] = 'ftp://ftp.kde.org/pub/kde/stable/4.8.' + ver + '/src/kde-l10n/kde-l10n-%s-4.8.' + ver + '.tar.bz2'
          self.targetInstSrc['4.8.' + ver] = 'kde-l10n-%s-4.8.' + ver
